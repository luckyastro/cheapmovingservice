...
$pop_url = '';
$redirect_url = 'https://cheapmovingservices.com/thankyou2.php';
...
<section class="home-banner lander1">
	...
	<form method="post" action="/transitions.php" id="formID" onsubmit="send()" class="form-common">
...
<div class="row">
					...
					*/ ?>
					...
					<div class="col-sm-12">
						...
						<input type="text" placeholder="E.g., 2004 Toyota Camry (year, make, model)" name="auto" value="" id="auto">
					</div>
				</div>
				<div class="row">
					 	<div class="col-sm-12">
					 		<input type="hidden" id="hidden_status_1" name="status_1" value="0">
					 <input type="checkbox" id="status_1" name="status_1" value="1" style="width: 3%;"><label>Do you want Car Shipping Info?</label><br>
					 <input type="hidden" id="hidden_status_2" name="status_2" value="0">
					 <input type="checkbox" id="status_2" name="status_2" value="1" style="width: 3%;"><label>Do you want help Finding Packing Supplies?</label><br>
					 <input type="hidden" id="hidden_status_3" name="status_3" value="0">
					 <input type="checkbox" id="status_3" name="status_3" value="1" style="width: 3%;"><label>Do you want a local contractor to contact you?</label><br>
					 <input type="hidden" id="hidden_status_4" name="status_4" value="0">
					 <input type="checkbox" id="status_4" name="status_4" value="1" style="width: 3%;"><label>Would you like Solar panels on your new home?</label><br>
					 	</div>
					 </div>
					
		            <!--<input name="submit" type="submit" value="Get FREE Quote!" class="submitbtn">-->
		            
		           <br><br> <input class="btn btn-success btn-md btn-block" type="submit"  name="post_lead" value="Get FREE Quote!"><br><br>
		         <p class="notice" style="font-size:8.5px;">"By clicking "Get FREE Quote!", I understand service providers will contact me for moving purposes, as well as any other services I have opted to know more about . I agree to receive autodialed and/or pre-recorded calls from Cheapmovingservices.com or it's partners or affilaites to the telephone number I have provided in this form. I understand this is not a condition of purchase."</p>
